...
function ModalInfoUser() {
    ...
    const handleUpdate = async () => {
       ...
       try {
           ...
           eventEmitter.emit('updateUserInfoDone')
            ...
            >
                <Box sx={style} className={'!border-0'}>
                    ...
                    <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                        <div className={'flex flex-col gap-4 p-4'} style={{ width: '100%', maxWidth: 600, margin: 'auto' }}>
                            ...
                            <div className={'flex gap-8'}>
                                ...
                                <input type="date" name={'NgaySinh'} defaultValue={userInfo?.NgaySinh} onChange={handleChange} style={{ padding: '10px', width: '100%', marginTop: '8px', border: '1px solid #ccc', borderRadius: '4px' }}/>
                            </div>
                        </div>
                        <div className={'w-full flex justify-end item-center !mt-10'} style={{ width: '100%', maxWidth: 750, margin: 'auto' }}>
                            <Button variant={'contained'} className={'w-[120px] h-12 !mx-4'}  onClick={handleUpdate} >Cập nhật</Button>
