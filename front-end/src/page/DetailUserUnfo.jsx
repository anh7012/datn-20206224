    ...
    return (
        <div>
            <Link to={'/home/quanlynhanvien'}
                  className={'flex items-center justify-start text-gray-500 hover:text-black mb-6'}><ArrowBackIcon
                className={'mr-2'}/> <p>Trở về trang quản lý</p></Link>
            <div className={'text-[18px] mb-4'}>Trang thông tin chi tiết của <strong>{userInfo?.HoTen}</strong></div>
            <div className={'mb-4'}>
