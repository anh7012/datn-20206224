...
import {getListHD, getListHoso, updateTrangThai} from "../../redux/apiRequest.js";
import {useSelector} from "react-redux";
import FileUpload from "../../components/UpLoadFile.jsx";
import {Button, Divider, MenuItem, Pagination, Select} from "@mui/material";
                                    ...
                                    {isSave.find(saveItem => saveItem.idHoSo === item.idHoSo)?.save && (
                                        <>
                                            <Button variant="contained" size={'small'} color="primary"
                                                    onClick={() => handleSaveStatus(item)}>Lưu</Button>
                                            <Button variant="contained" size={'small'} color="secondary"
                                                    onClick={() => handleCancelStatus(item)}>Huỷ</Button>
                                        </>
                                    )}
                                </div>
                            </div>
