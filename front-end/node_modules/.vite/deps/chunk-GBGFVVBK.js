import {
  NoSsr,
  Popper
} from "./chunk-NWYHZPTS.js";
import {
  Typography_default
} from "./chunk-Y4AKN3MF.js";
import {
  useSlotProps
} from "./chunk-6KWEQVZL.js";
import {
  useTheme
} from "./chunk-3JR2FZIL.js";
import {
  shouldForwardProp
} from "./chunk-UNM2K4K4.js";
import {
  init_ownerWindow,
  init_useControlled,
...
var CartesianContext = React11.createContext({
  xAxis: {},
  yAxis: {},
  xAxisIds: [],
  yAxisIds: []
...
function CartesianContextProvider(props) {
  ...
  const xAxis = React11.useMemo(() => inXAxis == null ? void 0 : inXAxis.map((axisConfig) => {
  ...
  const yAxis = React11.useMemo(() => inYAxis == null ? void 0 : inYAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
...
function useChartId() {
  ...
  return React15.useMemo(() => chartId, [chartId]);
}
...
var ChartContainer = React27.forwardRef(function ChartContainer2(props, ref) {
  const {
    width,
    height,
    series,
  ...
  const svgRef = React27.useRef(null);
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  ...
  const displayError = React28.useRef(false);
  const [width, setWidth] = React28.useState(0);
  const [height, setHeight] = React28.useState(0);
  const computeSize = React28.useCallback(() => {
...
var ResponsiveChartContainer = React29.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
...
function useColorProcessor(seriesType) {
  const colorProcessors = React37.useContext(ColorContext);
  if (!seriesType) {
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types11.default.shape({
    ...
    getColor: import_prop_types11.default.func,
    ...
    series: import_prop_types11.default.object,
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types13.default.shape({
    axis: import_prop_types13.default.object,
    axisData: import_prop_types13.default.shape({
      x: import_prop_types13.default.shape({
        index: import_prop_types13.default.number,
        value: import_prop_types13.default.oneOfType([import_prop_types13.default.instanceOf(Date), import_prop_types13.default.number, import_prop_types13.default.string]).isRequired
...
function DefaultChartsLegend(props) {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React42.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
//# sourceMappingURL=chunk-GBGFVVBK.js.map
