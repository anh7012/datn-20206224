import {
  ...
  useYScale,
  useZColorScale
} from "./chunk-GBGFVVBK.js";
import "./chunk-NWYHZPTS.js";
import "./chunk-Y4AKN3MF.js";
import "./chunk-GTEXFD5O.js";
import {
  useSlotProps
} from "./chunk-6KWEQVZL.js";
import "./chunk-S74UR3KX.js";
import "./chunk-3JR2FZIL.js";
import "./chunk-UNM2K4K4.js";
import "./chunk-UXXD4JXG.js";
import {
  ...
  useForkRef,
  useId
} from "./chunk-2Z6EKEI3.js";
import {
  styled_default
} from "./chunk-JVOWVAUX.js";
import {
  _extends,
...
} from "./chunk-562MJY2X.js";
import {
  require_prop_types
} from "./chunk-UMXHDM4H.js";
import "./chunk-AF5X3ZDO.js";
import {
  require_jsx_runtime
} from "./chunk-5FN62WUA.js";
import "./chunk-FWNH6KVE.js";
import {
  require_react
...
true ? BarLabelPlot.propTypes = {
  ...
  bars: import_prop_types9.default.arrayOf(import_prop_types9.default.shape({
    ...
    layout: import_prop_types9.default.oneOf(["horizontal", "vertical"]),
    maskId: import_prop_types9.default.string.isRequired,
    ...
    xOrigin: import_prop_types9.default.number.isRequired,
    y: import_prop_types9.default.number.isRequired,
    yOrigin: import_prop_types9.default.number.isRequired
  })).isRequired,
...
var BarChart = React14.forwardRef(function BarChart2(props, ref) {
  ...
  return (0, import_jsx_runtime14.jsxs)(ResponsiveChartContainer, {
    ...
    children: [onAxisClick && (0, import_jsx_runtime14.jsx)(ChartsOnAxisClickHandler, {
      ...
      children: [(0, import_jsx_runtime14.jsx)(BarPlot, {
        slots,
        slotProps,
        skipAnimation,
        onItemClick,
      ...
      slots,
      slotProps
    })), (0, import_jsx_runtime14.jsx)(ChartsAxisHighlight, _extends({}, defaultizedAxisHighlight)), !loading && (0, import_jsx_runtime14.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
...
true ? BarChart.propTypes = {
   ...
   * @returns {string} The formatted label.
   */
  barLabel: import_prop_types11.default.oneOfType([import_prop_types11.default.oneOf(["value"]), import_prop_types11.default.func]),
  /**
   * Defines the border radius of the bar element.
   */
  borderRadius: import_prop_types11.default.number,
  /**
   ...
   * @default 'vertical'
   */
  layout: import_prop_types11.default.oneOf(["horizontal", "vertical"]),
  /**
...
var _excluded8 = ["d", "skipAnimation", "ownerState"];
...
var _excluded9 = ["id", "classes", "color", "gradientId", "slots", "slotProps", "onClick"];
...
var _excluded10 = ["slots", "slotProps", "onItemClick", "skipAnimation"];
...
var _excluded12 = ["id", "classes", "color", "gradientId", "slots", "slotProps", "onClick"];
...
var _excluded13 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
...
var _excluded14 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "onClick", "skipAnimation"];
...
var _excluded15 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
function MarkPlot(props) {
  ...
  const seriesData = useLineSeries();
  const axisData = React23.useContext(CartesianContext);
  const chartId = useChartId();
  ...
  return (0, import_jsx_runtime22.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.map((seriesId) => {
        ...
        const colorGetter = getColor3(series[seriesId], xAxis[xAxisKey], yAxis[yAxisKey]);
...
var LineChart = React26.forwardRef(function LineChart2(props, ref) {
  ...
  return (0, import_jsx_runtime25.jsxs)(ResponsiveChartContainer, {
    ...
    highlightedItem,
    onHighlightChange,
    children: [onAxisClick && (0, import_jsx_runtime25.jsx)(ChartsOnAxisClickHandler, {
      onAxisClick
    }), grid && (0, import_jsx_runtime25.jsx)(ChartsGrid, {
      vertical: grid.vertical,
      horizontal: grid.horizontal
      ...
      children: [(0, import_jsx_runtime25.jsx)(AreaPlot, {
        ...
        skipAnimation
      }), (0, import_jsx_runtime25.jsx)(ChartsOverlay, {
        loading,
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime25.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime25.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime25.jsx)(MarkPlot, {
      slots,
      slotProps,
      ...
      slots,
      slotProps
    }), (0, import_jsx_runtime25.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), !loading && (0, import_jsx_runtime25.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime25.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
...
function ScatterPlot(props) {
  ...
  const axisData = React28.useContext(CartesianContext);
  const {
    zAxis,
    zAxisIds
...
var ScatterChart = React29.forwardRef(function ScatterChart2(props, ref) {
  ...
  return (0, import_jsx_runtime28.jsx)(ResponsiveChartContainer, {
    ref,
    series: series.map((s) => _extends({
      type: "scatter"
    }, s)),
    ...
    highlightedItem,
    onHighlightChange,
    children: (0, import_jsx_runtime28.jsxs)(ZAxisContextProvider, {
      zAxis,
      children: [!disableVoronoi && (0, import_jsx_runtime28.jsx)(ChartsVoronoiHandler, {
        voronoiMaxRadius,
        onItemClick
      }), (0, import_jsx_runtime28.jsx)(ChartsAxis, {
        topAxis,
        leftAxis,
        rightAxis,
        bottomAxis,
        slots,
        slotProps
      }), grid && (0, import_jsx_runtime28.jsx)(ChartsGrid, {
        vertical: grid.vertical,
        horizontal: grid.horizontal
      }), (0, import_jsx_runtime28.jsx)(ScatterPlot, {
        slots,
        slotProps,
        onItemClick: disableVoronoi ? onItemClick : void 0
      }), (0, import_jsx_runtime28.jsx)(ChartsOverlay, {
        loading,
        slots,
        slotProps
      }), (0, import_jsx_runtime28.jsx)(ChartsLegend, _extends({}, legend, {
        slots,
        slotProps
      })), (0, import_jsx_runtime28.jsx)(ChartsAxisHighlight, _extends({
        x: "none",
        y: "none"
      }, axisHighlight)), !loading && (0, import_jsx_runtime28.jsx)(ChartsTooltip, _extends({
        trigger: "item"
      }, tooltip)), children]
    })
  });
...
var SparkLineChart = React30.forwardRef(function SparkLineChart2(props, ref) {
  ...
  return (0, import_jsx_runtime29.jsxs)(ResponsiveChartContainer, {
    ref,
    series: [_extends({
      type: plotType,
      data,
...
var _excluded18 = ["width", "height", "margin", "title", "desc", "value", "valueMin", "valueMax", "startAngle", "endAngle", "outerRadius", "innerRadius", "cornerRadius", "cx", "cy", "children"];
...
var _excluded20 = ["text", "children", "classes"];
